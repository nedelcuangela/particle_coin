...
<section class="px-6 py-8">
    ...
    <header class="max-w-xl mx-auto mt-20 text-center">
        ...
        <h2 class="inline-flex mt-2">By Lary Laracore <img src="./images/lary-head.png"
            ...
            <div class="py-6 px-5 lg:flex">
                ...
                <div class="flex-1 flex flex-col justify-between">
                    <header class="mt-8 lg:mt-0">
                        ...
                        <div class="mt-4">
                            <h1 class="text-3xl">
                                <a href="/posts/my-first-post">This is a big title and it will look great on two or even three lines. Wooohoo!</a>
                            </h1>
                ...
                <form method="POST" action="#" class="lg:flex text-sm">
                    <div class="lg:py-3 lg:px-5 flex items-center">
                        <label for="email" class="hidden lg:inline-block">
                            <img src="./images/mailbox-icon.png" alt="mailbox letter">
                        </label>
